  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">P&L Dashboard</h2>
      </div>
                  ...
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center">
                      <div className="ml-4 space-y-1">
                        <p className="text-sm font-medium leading-none">Transaction {i}</p>
                        <p className="text-sm text-muted-foreground">
                          $1,234.00 - {new Date().toLocaleDateString()}
                        </p>
                      </div>
                      <div className="ml-auto font-medium">
                        {i % 2 === 0 ? (
                          <span className="text-green-500">+$1,234.00</span>
                        ) : (
                          <span className="text-red-500">-$1,234.00</span>
                        )}
                      </div>
                    </div>
                  ))}
